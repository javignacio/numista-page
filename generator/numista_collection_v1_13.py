...
@media (max-width: 700px){
  ...
  .chileMissingCell{font-weight:600;}
	...
	html.append("<section id='panel-uk-pennies' class='appPanel'><div class='modeHeader compactAnalyticsHeader'><h2>United Kingdom date runs</h2></div><div id='ukPennyRunsPanel' class='analyticsPanel'></div></section>")
...
(function(){
  ...
  function renderUkPennyRuns(){
    renderDateRuns({panelId:'ukPennyRunsPanel', issuerRoot:'united kingdom', curated:window.__NUMISTA_UK_PENNY_DATE_RUNS, label:'UK', fileLabel:'uk_penny_date_runs.csv', countryQuery:'united kingdom', countryFilter:'United Kingdom', groupBySeries:true});
  }
